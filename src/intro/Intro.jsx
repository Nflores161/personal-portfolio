...
import './intro.css'
import Me from '../img/Nick-Proffesional.png'
    ...
    <div className='intro'>
      <div className='intro-left'>
        <div className='intro-left-wrapper'>
          ...
          <h1 className='intro-name'>Nick Flores-Tober</h1>
          <div className='intro-title'>
            <div className='intro-title-wrapper'>
              <div className='intro-title-item'>Full Stack Engineer</div>
              <div className='intro-title-item'>Web Developer</div>
              <div className='intro-title-item'>Life Learner</div>
